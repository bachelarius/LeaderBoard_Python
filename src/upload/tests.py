...
class RankingGeneratorServiceTest(TestCase):
    def test_generate_ranking_enough_submissions(self):
        ...
        submission3 = SubmissionDto(contestant_name="test_contestant", competition_name="test_competition_3", date=date(2021, 1, 3), score=30)
        ...
        if ranking:
            ...
            self.assertEqual(ranking.latest_submission_date, date(2023, 1, 1))
