...
class RankingGeneratorServiceTest(TestCase):
    def test_generate_ranking_enough_submissions(self):
        ...
        submission2 = SubmissionDto(contestant_name="test_contestant", competition_name="test_competition_2", date=date(2023, 1, 2), score=20)
        submission3 = SubmissionDto(contestant_name="test_contestant", competition_name="test_competition_3", date=date(2023, 1, 2), score=30)
